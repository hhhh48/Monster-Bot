...
console.log("log");
 ...
 client.on('message', message => {
    if (message.content.startsWith("https://discord.gg/6avmCNe")) {
...
if (message.content.startsWith('!bcall')){
 if (message.author.id !== '454022583709466625') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
...
m.sendMessage(args)
 ...
 client.on('message' , function (message){
      var token = 'NDk4NjUxNTAwMTQ3NTA3MjMw.DrB6PQ.YIUuw9lihRGmj4-SWh5_b6ja3so'; // التوكن هنا بس
      if(message.content === '!restart') {
if(message.author.id !== '454022583709466625') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
          client.destroy();
